  ...
  Future<void> fetchSoilData(
    ...
    try {
      var soilResponse = await http.get(
        Uri.parse('http://35.244.43.148:5000/soil/currentSoilData')
      ...
      var msCropResponse = await http.get(
        Uri.parse('http://35.244.43.148:5000/soil/mithranScoreForCrop')
            .replace(queryParameters: {
          'polyid': polygonId,
          'crop': crop,
        }),
      ...
      var msResponse = await http.get(
        Uri.parse('http://35.244.43.148:5000/soil/mithranScore')
            .replace(queryParameters: {
          'polyid': polygonId,
        }),
      );
