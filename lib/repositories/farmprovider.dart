  ...
  Future<void> fetchSoilData(
    ...
    try {
      var soilResponse = await http.get(
        Uri.parse('http://34.93.22.161:3000/soil/currentSoilData')
      ...
      var msCropResponse = await http.get(
        Uri.parse('http://34.93.22.161:3000/soil/mithranScoreForCrop')
            .replace(queryParameters: {
          'polyid': polygonId,
          'crop': crop,
        }),
      ...
      var msResponse = await http.get(
        Uri.parse('http://34.93.22.161:3000/soil/mithranScore')
            .replace(queryParameters: {
          'polyid': polygonId,
        }),
      );
